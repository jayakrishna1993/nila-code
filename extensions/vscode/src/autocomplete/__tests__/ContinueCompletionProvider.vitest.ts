...
import { NilaCodeCompletionProvider } from "../completionProvider";
...
describe("NilaCodeCompletionProvider triggering logic", () => {
...
function buildProvider(options: { usingFullFileDiff?: boolean } = {}) {
  ...
  const provider = new NilaCodeCompletionProvider(
    configHandler,
    ide,
    webviewProtocol,
    usingFullFileDiff,
