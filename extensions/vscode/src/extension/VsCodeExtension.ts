...
import { NilaCodeCompletionProvider } from "../autocomplete/completionProvider";
import {
...
export class VsCodeExtension {
  ...
  private consoleView: NilaCodeConsoleWebviewViewProvider;
  private sidebar: NilaCodeGUIWebviewViewProvider;
  ...
  private completionProvider: NilaCodeCompletionProvider;
        ...
        .then((selection) => {
          if (selection === "Disable Next Edit") {
            ...
            vscode.commands.executeCommand(
              "nila-code.openTabAutocompleteConfigMenu",
            );
          }
        });
    }
  ...
  constructor(context: vscode.ExtensionContext) {
    ...
    this.sidebar = new NilaCodeGUIWebviewViewProvider(
      this.windowId,
    ...
    this.completionProvider = new NilaCodeCompletionProvider(
      this.configHandler,
      this.ide,
      this.sidebar.webviewProtocol,
      usingFullFileDiff,
    ...
    // LLM Log view
    this.consoleView = new NilaCodeConsoleWebviewViewProvider(
      this.windowId,
      this.extensionContext,
      this.core.llmLogger,
    );
    ...
    vscode.authentication.onDidChangeSessions(async (e) => {
      ...
      if (e.provider.id === env.AUTH_TYPE) {
        void vscode.commands.executeCommand(
          "setContext",
          "nila-code.isSignedInToControlPlane",
          true,
        );
