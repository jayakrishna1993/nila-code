            ...
            <Card>
              <div className="flex flex-col gap-4">
                <UserSetting
                  ...
                  description="Allows NILA_Code to send anonymous telemetry."
              ...
              >
                <div className="flex flex-col gap-x-1 gap-y-4">
                  ...
                  <UserSetting
                    ...
                    description=" NILA_Code will not attempt to use native tool calling and will only use system message tools."
