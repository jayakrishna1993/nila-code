# Contributing to Nila Code

## Table of Contents

- [Contributing to Nila Code](#contributing-to-nila-code)
  - [Table of Contents](#table-of-contents)
- [❤️ Ways to Contribute](#️-ways-to-contribute)
  - [👋 Nila Code Contribution Ideas](#-nila-code-contribution-ideas)
  ...
  - [🧑‍💻 Contributing Code](#-contributing-code)
    - [Environment Setup](#environment-setup)
      ...
      - [Fork the Nila Code Repository](#fork-the-nila-code-repository)
      - [VS Code](#vs-code)
        - [Debugging](#debugging)
      - [JetBrains](#jetbrains)
  ...
  - [📐 Nila Code Architecture](#-nila-code-architecture)
    - [Nila Code VS Code Extension](#nila-code-vs-code-extension)
    - [Nila Code JetBrains Extension](#nila-code-jetbrains-extension)
  - [Contributor License Agreement](#contributor-license-agreement-cla)

# ❤️ Ways to Contribute

## 👋 Nila Code Contribution Ideas

The [GitHub Issues page](https://github.com/jayakrishna1993/nila-code/issues) is the best place to find ways to
contribute to Nila Code. You can browse the list
of [good first issues](https://github.com/jayakrishna1993/nila-code/issues?q=is:issue%20state:open%20label:good-first-issue).

## 🐛 Report Bugs

If you find a bug, please [create an issue](https://github.com/jayakrishna1993/nila-code/issues) to report it! A great bug
report includes:
...
Nila Code is quickly adding features, and we'd love to hear which are the most important to you. The best ways to suggest
an enhancement are:

- Create an issue

  - First, check whether a similar proposal has already been made
  - If not, [create an issue](https://github.com/jayakrishna1993/nila-code/issues)
  - Please describe the enhancement in as much detail as you can, and why it would be useful

- Join the [GitHub Discussions](https://github.com/jayakrishna1993/nila-code/discussions) and tell us about your idea

## 📖 Updating / Improving Documentation

Nila Code is continuously improving, but a feature isn't complete until it is reflected in the documentation! If you see
something out-of-date or missing, you can help by opening a PR or issue on
[GitHub](https://github.com/jayakrishna1993/nila-code).
...
#### Fork the Nila Code Repository

1. Go to the [Nila Code GitHub repository](https://github.com/jayakrishna1993/nila-code) and fork it to your GitHub account.

2. Clone your forked repository to your local machine. Use: `git clone https://github.com/YOUR_USERNAME/nila-code.git`
...
3. To package the extension, run `npm run package` in the `extensions/vscode` directory, select `Tasks: Run Task` and
   then select `vscode-extension:package`. This will generate a `.vsix` file in `extensions/vscode/build/`, which
...
To keep the Nila Code codebase clean and maintainable, we expect the following from our own team and all contributors:
...
- **For new features**: Include a short screen recording or screenshot demonstrating the new functionality. This makes it much easier for us as contributors to review and understand your changes.
- Open a PR against the `main` branch. Make sure to fill in the PR template

### Formatting

Nila Code uses [Prettier](https://marketplace.visualstudio.com/items?itemName=esbenp.prettier-vscode) to format
JavaScript/TypeScript. Please install the Prettier extension in VS Code and enable "Format on Save" in your settings.

### Theme Colors

Nila Code has a set of named theme colors that we map to extension colors and tailwind classes, which can be found in [gui/src/styles/theme.ts](gui/src/styles/theme.ts)
...
- Choose sensible VS Code variables to add/update in [gui/src/styles/theme.ts](gui/src/styles/theme.ts) (see [here](https://code.visualstudio.com/api/references/theme-color) for inspiration)
- Choose sensible JetBrains named colors to add/update in `GetTheme.kt`
...
Join the [GitHub Discussions](https://github.com/jayakrishna1993/nila-code/discussions) to engage with maintainers and other contributors.

## Contributing New LLM Providers/Models

### Adding an LLM Provider

Nila Code has support for more than a dozen different LLM "providers", making it easy to use models running on OpenAI,
Ollama, Together, LM Studio, Msty, and more. You can find all of the existing
providers [here](https://github.com/jayakrishna1993/nila-code/tree/main/core/llm/llms), and if you see one missing, you can
...
While any model that works with a supported provider can be used with Nila Code, we keep a list of recommended models
...
- LLM Providers: Since many providers use their own custom strings to identify models, you'll have to add the
  translation from Nila Code's model name (the one you added to `index.d.ts`) and the model string for each of these
...
- [Prompt Templates](./core/llm/autodetect.ts) - In this file you'll find the `autodetectTemplateType` function. Make
  ...
  the chat template for that model is already built in Nila Code. If not, you will have to add the template type and
